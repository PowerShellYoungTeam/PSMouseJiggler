@{
    ...
    Author                 = 'PSMouseJiggler Team'

    # Company or vendor of this module
    CompanyName            = 'Unknown'

    # Copyright statement for this module
    Copyright              = '(c) PSMouseJiggler Team. All rights reserved.'
    ...
    PrivateData            = @{
        PSData = @{
            ...
            LicenseUri               = 'https://github.com/yourusername/PSMouseJiggler/blob/main/LICENSE'

            # A URL to the main website for this project.
            ProjectUri               = 'https://github.com/yourusername/PSMouseJiggler'
